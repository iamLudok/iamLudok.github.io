...
(function () {
  const translations = {
    en: {
      ...
      project_elkano_desc:      'Financial health platform for companies, built at HackSpain 2026 for Embat\'s challenge. Turns banking movements and invoice data into a 0-100 financial stress score, then offers a credit marketplace, continuous credit insurance and cash pooling on top of it.',
      project_ludoktime_desc:   'Android app to track series, movies, books and manga, episode by episode or chapter by chapter. Born after TV Time lost my entire history, so here the data is mine, living on my phone with an automatic daily backup to my own Nextcloud.',
      ...
      private_note:   'This project is finished but kept private for now.',
      ...
      project_elkano_story:          'At HackSpain, Embat set the challenge: help companies see financial trouble coming instead of finding out from a missed payment. Elkano scores each company\'s financial stress from 105 variables built on top of banking movements and invoice history, 24 core metrics, trend analysis and 9 stress signals, validated on a dataset of 1,286 companies, 24 months of banking data and 900k invoices, with a Gini coefficient of 0.54 one month out. On top of the score we built three products: a credit marketplace so cash-rich companies can lend to those under stress, continuous credit insurance on receivables with premiums that move with the score, and cash pooling so subsidiaries share group liquidity before going to a bank. Team of five, working from Friday evening to Sunday late morning.',
      project_elkano_tags:           'Next.js, TypeScript, Docker, Vercel, Python, Git',
      project_elkano_learned:        'financial risk scoring, rapid prototyping',
      ...
      project_jaialai_private_note:  'This project is finished but kept private. The documents it works with contain personal information from real people, making them publicly accessible without their consent would be both a legal and an ethical problem.',

      project_ludoktime_story:       'TV Time went down for a few hours and I panicked realising my entire watch history lived on someone else\'s server. I rebuilt it as a native Android app: series, movies, books and manga in one place, tracked episode by episode or chapter by chapter, with an automatic daily backup to my own Nextcloud. It used to be a PWA, but GrapheneOS can\'t install WebAPKs, so it got rewritten from scratch as a proper native app. The data layer is tested against a desktop SQLite before it ever touches a phone, because losing years of watch history once was enough.',
      project_ludoktime_tags:        'Expo, React Native, TypeScript, SQLite, Drizzle, TMDB, MangaDex, Nextcloud, Git',
      project_ludoktime_learned:     'data integrity testing, self-hosted backups',
      project_ludoktime_private_note: 'The repo is private simply because it\'s a personal app I never got around to publishing, there\'s nothing sensitive in the code itself. Ask me if you want to see it.',

      project_ludokbeen_story:       'I wanted a "been" style app for the countries I\'ve visited, but free, without an account, and without my travel history sitting on someone else\'s server. It was a PWA first, then rewritten as a native Android app for real system scroll and gestures, and storage that only disappears if I uninstall it myself. Tap a country on the map to mark it, tap again to switch between visited and want-to-go, and share a card with your percentage of the world.',
      project_ludokbeen_tags:        'Expo, React Native, TypeScript, SQLite, Drizzle, D3, Git',
      project_ludokbeen_learned:     'offline-first, custom map interaction',
      project_ludokbeen_private_note: 'The repo is private simply because it\'s a personal app I never got around to publishing, there\'s nothing sensitive in the code itself. Ask me if you want to see it.',

      project_ludokwallet_story:     'It started as Ludovis, a Flutter app for keeping tickets and restaurant cards since GrapheneOS has no Google Wallet. I rewrote it from scratch in Expo/React Native to match the rest of my apps, and used the rewrite to go much further: any kind of card, not just restaurants, with OCR that reads phone, email and address off a photo of the card itself. Tickets now come from a photo, a PDF or Android\'s share menu, reading the barcode and prefilling the form in one pass. A migration script pulls the old Flutter SQLite database and photos across so nothing gets lost in the switch.',
      project_ludokwallet_tags:      'Expo, React Native, TypeScript, SQLite, Drizzle, ML Kit OCR, Git',
      project_ludokwallet_learned:   'ocr pipelines, barcode/QR generation',
      project_ludokwallet_private_note: 'The repo is private simply because it\'s a personal app I never got around to publishing, there\'s nothing sensitive in the code itself. Ask me if you want to see it.',

      project_ludoktaste_story:      'I wanted to keep track of what I eat and what I actually like from each restaurant\'s menu, so I stop ordering blind the next time I go back. It was an offline-first PWA at first; rewritten as a native app to match Ludok Time and Ludok Been, with photos bundled straight into the JSON backup.',
      ...
      edu1_date:  '2026/09 - Present',
      edu1_title: "Master's Degree in Applied Artificial Intelligence",
      edu1_desc:  'Started right after finishing my Computer Engineering degree.',
      edu2_date:  '2022/09 - 2026/07',
      edu2_title: 'Computer Engineering Degree',
      edu2_desc:  'Graduated. Focused on databases, security and AI.',
    ...
    es: {
      ...
      project_elkano_desc:      'Plataforma de salud financiera para empresas, construida en HackSpain 2026 para el reto de Embat. Convierte movimientos bancarios y facturas en una puntuación de estrés financiero de 0 a 100, y encima ofrece un marketplace de crédito, seguro de crédito continuo y cash pooling.',
      project_ludoktime_desc:   'App Android para llevar el registro de series, películas, libros y manga, episodio a episodio o capítulo a capítulo. Nació cuando TV Time perdió mi historial entero: aquí los datos son míos y viven en mi móvil, con copia automática diaria a mi propio Nextcloud.',
      ...
      private_note:   'Este proyecto está terminado pero de momento se mantiene privado.',
      ...
      project_elkano_story:          'En HackSpain, el reto de Embat era ayudar a las empresas a ver venir los problemas financieros en lugar de enterarse por un impago. Elkano puntúa el estrés financiero de cada empresa a partir de 105 variables construidas sobre movimientos bancarios e historial de facturas, 24 métricas base, análisis de tendencia y 9 señales de estrés, validado sobre un dataset de 1.286 empresas, 24 meses de datos bancarios y 900.000 facturas, con un coeficiente de Gini de 0,54 a un mes vista. Sobre esa puntuación montamos tres productos: un marketplace de crédito para que las empresas con caja presten a las que están en estrés, un seguro de crédito continuo sobre las facturas por cobrar con primas que se mueven con la puntuación, y cash pooling para que las filiales compartan liquidez del grupo antes de acudir a un banco. Equipo de cinco, trabajando desde la tarde del viernes hasta la mañana del domingo.',
      ...
      project_jaialai_private_note:  'Este proyecto está terminado pero es privado. Los documentos con los que trabaja contienen información personal de personas reales, hacerlos públicamente accesibles sin su consentimiento sería un problema legal y ético.',
      project_ludoktime_story:       'TV Time se cayó unas horas y me entró el pánico al darme cuenta de que todo mi historial vivía en el servidor de otro. La reconstruí como app Android nativa: series, películas, libros y manga en un solo sitio, con seguimiento episodio a episodio o capítulo a capítulo, y copia automática diaria a mi propio Nextcloud. Antes era una PWA, pero GrapheneOS no puede instalar WebAPKs, así que se reescribió desde cero como app nativa de verdad. La capa de datos se prueba contra un SQLite de escritorio antes de tocar un móvil, porque perder años de historial una vez ya fue suficiente.',
      project_ludoktime_private_note: 'El repo es privado sin más motivo que no haberlo publicado nunca, no hay nada delicado en el código en sí. Pregúntame si quieres verlo.',
      project_ludokbeen_story:       'Quería una app tipo "been" para los países que he visitado, pero gratis, sin cuenta y sin que mi historial de viajes viva en el servidor de otro. Primero fue una PWA, luego la reescribí como app Android nativa para tener el scroll y los gestos reales del sistema, y un almacenamiento que solo desaparece si la desinstalo yo mismo. Tocas un país en el mapa para marcarlo, vuelves a tocar para cambiar entre visitado y quiero ir, y compartes una tarjeta con tu porcentaje del mundo.',
      project_ludokbeen_private_note: 'El repo es privado sin más motivo que no haberlo publicado nunca, no hay nada delicado en el código en sí. Pregúntame si quieres verlo.',
      project_ludokwallet_story:     'Empezó como Ludovis, una app en Flutter para guardar entradas y tarjetas de restaurantes porque GrapheneOS no tiene Google Wallet. La reescribí desde cero en Expo/React Native para seguir el mismo patrón que mis otras apps, y aproveché la reescritura para ir mucho más lejos: cualquier tipo de tarjeta, no solo restaurantes, con un OCR que saca teléfono, email y dirección de una foto de la propia tarjeta. Las entradas ahora se importan desde una foto, un PDF o el menú de compartir de Android, leyendo el código de barras y rellenando el formulario en un solo paso. Un script de migración trae la base de datos SQLite y las fotos de la vieja versión en Flutter para que nada se pierda en el cambio.',
      project_ludokwallet_tags:      'Expo, React Native, TypeScript, SQLite, Drizzle, ML Kit OCR, Git',
      project_ludokwallet_learned:   'pipelines de OCR, generación de códigos de barras/QR',
      project_ludokwallet_private_note: 'El repo es privado sin más motivo que no haberlo publicado nunca, no hay nada delicado en el código en sí. Pregúntame si quieres verlo.',
      project_ludoktaste_story:      'Quería ir apuntando lo que como y lo que de verdad me gusta de la carta de cada restaurante, para dejar de pedir a ciegas la próxima vez que vuelvo. Antes era una PWA offline-first; la reescribí como app nativa para seguir el mismo patrón que Ludok Time y Ludok Been, con las fotos metidas directamente en la copia de seguridad JSON.',
      project_ludoktaste_tags:       'Expo, React Native, TypeScript, SQLite, Drizzle, Git',
      ...
      edu1_date:  '2026/09 - Actualidad',
      edu1_title: 'Máster en Inteligencia Artificial Aplicada',
      edu1_desc:  'Empezado justo después de terminar el Grado en Ingeniería Informática.',
      edu2_date:  '2022/09 - 2026/07',
      edu2_title: 'Grado en Ingeniería Informática',
      edu2_desc:  'Graduado. Especializado en bases de datos, seguridad e IA.',
    ...
    eu: {
      ...
      project_elkano_desc:      'Enpresentzako osasun finantzarioko plataforma, HackSpain 2026n Embat-en erronkarako eraikia. Banku-mugimenduak eta fakturak 0-100eko estres finantzario puntuazio bihurtzen ditu, eta horren gainean kreditu-merkatu bat, kreditu-aseguru jarraitua eta cash pooling eskaintzen ditu.',
      project_jaialai_desc:     'Jai Alai kirolari eta kulturari buruzko ezagutza espezializatua duen AI chatbota.',
      project_ludoktime_desc:   'Serieak, filmak, liburuak eta manga atal edo kapituluz kapitulu erregistratzeko Android app-a. TV Time-k nire historial osoa galdu zuenean sortu zen: hemen datuak nireak dira, nire mugikorrean bizi dira, eta nire Nextcloud propiora egunero babeskopia automatikoa egiten dute.',
      ...
      private_note:   'Proiektu hau bukatuta dago baina oraingoz pribatua da.',
      ...
      project_elkano_story:          'HackSpain-en, Embat-en erronka enpresei arazo finantzarioak ordainketa bat galdu aurretik ikusten laguntzea zen. Elkanok enpresa bakoitzaren estres finantzarioa puntuatzen du banku-mugimenduen eta fakturen historialean oinarritutako 105 aldagairekin, 24 oinarrizko metrikarekin, joera-analisiarekin eta 9 estres-seinalerekin, 1.286 enpresa, 24 hilabeteko banku-datu eta 900.000 fakturako datu-multzo batean balidatua, 0,54ko Gini koefizientearekin hilabete batera. Puntuazio horren gainean hiru produktu eraiki genituen: kreditu-merkatu bat kutxa duten enpresek estresean daudenei mailegatzeko, kobratzeko dauden fakturen gaineko kreditu-aseguru jarraitua puntuazioarekin batera mugitzen diren primekin, eta cash pooling bat filialek taldearen likidezia partekatzeko banku batera jo aurretik. Bost lagunetako taldea, ostiral arratsaldetik igande goizera arte lanean.',
      project_elkano_tags:           'Next.js, TypeScript, Docker, Vercel, Python, Git',
      project_elkano_learned:        'arrisku finantzarioaren puntuazioa, prototipaketa azkarra',
      ...
      project_jaialai_private_note:  'Proiektu hau bukatuta dago baina pribatua da. Erabiltzen dituen dokumentuak benetako pertsonen informazio pertsonala dute, haien baimenik gabe publikoki eskuragarri egitea arazo legal eta etiko bat izango litzateke.',

      project_ludoktime_story:       'TV Time zenbait ordutan erori zen eta izua sartu zitzaidan, konturatuta nire ikusitako guztiaren historiala beste baten zerbitzarian bizi zela. Android app natibo gisa berreraiki nuen: serieak, filmak, liburuak eta manga leku bakarrean, atal edo kapituluz kapitulu jarraituta, eguneroko babeskopia automatikoarekin nire Nextcloud propiora. Lehen PWA bat zen, baina GrapheneOS-ek ezin ditu WebAPK-ak instalatu, beraz hutsetik berridatzi zen app natibo egoki gisa. Datu-geruza mahaigaineko SQLite baten kontra probatzen da mugikor bati ukitu baino lehen, ikusitako historiala behin galtzea nahikoa izan zelako.',
      project_ludoktime_tags:        'Expo, React Native, TypeScript, SQLite, Drizzle, TMDB, MangaDex, Nextcloud, Git',
      project_ludoktime_learned:     'datu-integritatearen probak, babeskopia autoalojatuak',
      project_ludoktime_private_note: 'Errepositorioa pribatua da argitaratu ez dudalako, ez besterik; kodean berean ez dago ezer sentikorrik. Galdetu ikusi nahi baduzu.',

      project_ludokbeen_story:       'Bisitatu ditudan herrialdeentzako "been" motako app bat nahi nuen, baina doakoa, konturik gabe eta nire bidaia-historiala beste baten zerbitzarian bizi gabe. Lehenengo PWA bat izan zen, gero Android app natibo gisa berridatzi nuen sistemaren benetako scroll eta keinuak izateko, eta nik neuk desinstalatzen dudanean bakarrik desagertzen den biltegiratzea izateko. Herrialde bat ukitu mapan markatzeko, berriro ukitu bisitatuaren eta joan-nahi-dudanaren artean aldatzeko, eta munduaren zure ehunekoarekin txartel bat partekatzeko.',
      project_ludokbeen_tags:        'Expo, React Native, TypeScript, SQLite, Drizzle, D3, Git',
      project_ludokbeen_learned:     'offline-first, mapa-interakzio pertsonalizatua',
      project_ludokbeen_private_note: 'Errepositorioa pribatua da argitaratu ez dudalako, ez besterik; kodean berean ez dago ezer sentikorrik. Galdetu ikusi nahi baduzu.',

      project_ludokwallet_story:     'Ludovis izenarekin hasi zen, Flutter-eko app bat sarrerak eta jatetxe-txartelak gordetzeko, GrapheneOS-ek ez baitu Google Wallet. Hutsetik berridatzi nuen Expo/React Native-n nire beste app-en patroi berari jarraitzeko, eta berridazketa aprobetxatu nuen askoz urrunago joateko: edozein motatako txartela, ez soilik jatetxeak, txartelaren argazki batetik telefonoa, emaila eta helbidea ateratzen dituen OCR batekin. Sarrerak orain argazki batetik, PDF batetik edo Androiden partekatze-menutik inportatzen dira, barra-kodea irakurriz eta formularioa pauso bakarrean betez. Migrazio-script batek Flutter bertsio zaharreko SQLite datu-basea eta argazkiak ekartzen ditu, aldaketan ezer galdu ez dadin.',
      project_ludokwallet_tags:      'Expo, React Native, TypeScript, SQLite, Drizzle, ML Kit OCR, Git',
      project_ludokwallet_learned:   'OCR pipelineak, barra-kode/QR sorkuntza',
      project_ludokwallet_private_note: 'Errepositorioa pribatua da argitaratu ez dudalako, ez besterik; kodean berean ez dago ezer sentikorrik. Galdetu ikusi nahi baduzu.',

      project_ludoktaste_story:      'Jatetxe bakoitzeko kartatik jaten dudana eta benetan gustatzen zaidana apuntatu nahi nuen, hurrengoan itzultzean itsu-itsuan ez eskatzeko. Lehen offline-first PWA bat zen; app natibo gisa berridatzi nuen Ludok Time eta Ludok Been-en patroi berari jarraitzeko, argazkiak zuzenean JSON babeskopian sartuta.',
      project_ludoktaste_tags:       'Expo, React Native, TypeScript, SQLite, Drizzle, Git',
      ...
      challenge_hackupc_sub:  'UPC, Bartzelona',
      ...
      challenge_thegame_sub:  'UPC, Bartzelona',
      ...
      edu1_date:  '2026/09 - Gaur egun',
      edu1_title: 'Adimen Artifizial Aplikatuko Masterra',
      edu1_desc:  'Informatika Ingeniaritza Gradua bukatu bezain laster hasia.',
      edu2_date:  '2022/09 - 2026/07',
      edu2_title: 'Informatika Ingeniaritza Gradua',
      edu2_desc:  'Graduatua. Datu-baseak, segurtasuna eta AIan espezializatuta.',
