...
(function () {
  const translations = {
    en: {
      ...
      evt1_date:  '2024/03',
      evt1_title: 'First Lego League',
      evt1_place: 'Arrasate / Mondragón',
      evt1_desc:  'Volunteer scientific project judge at FIRST Lego League Euskadi.',
      evt2_date:  '2025/02',
      evt2_title: 'First Lego League',
      evt2_place: 'Arrasate / Mondragón',
      evt2_desc:  'Volunteer scientific project judge at FIRST Lego League Euskadi.',
      evt3_date:  '2025/09/27',
      evt3_title: 'NetcoreConf',
      evt3_place: 'Bilbao',
      evt3_desc:  'Talks on .NET, Azure, Kubernetes, AI, Data, Power Platform and everything related to the Microsoft ecosystem.',
      evt7_date:  '2025/11/22',
      evt7_title: 'MU Open Day',
      evt7_place: 'Arrasate / Mondragón',
      evt7_desc:  'Speaker at Mondragon University Open Day. Presenting PBL projects to prospective students and their families.',
      evt8_date:  '2026/01/17',
      evt8_title: 'MU Open Day',
      evt8_place: 'Arrasate / Mondragón',
      evt8_desc:  'Speaker at Mondragon University Open Day. Presenting PBL projects to prospective students and their families.',
      evt4_date:  '2026/02',
      evt4_title: 'First Lego League',
      evt4_place: 'Arrasate / Mondragón',
      evt4_desc:  'Volunteer scientific project judge at FIRST Lego League Euskadi.',
      evt6_date:  '2026/03/07',
      evt6_title: 'Cursor Meetup Bilbao',
      evt6_place: 'Bilbao',
      evt6_desc:  'Talks, demos and networking on AI-assisted development.',
      evt9_date:  '2026/03/14',
      evt9_title: 'MU Open Day',
      evt9_place: 'Arrasate / Mondragón',
      evt9_desc:  'Speaker at Mondragon University Open Day. Presenting PBL projects to prospective students and their families.',
      evt5_date:  '2026/05/14',
      evt5_title: 'ApplAI',
      evt5_place: 'Donostia',
      evt5_desc:  'The Applied AI Congress of Euskadi.',
    ...
    es: {
      ...
      events_heading: 'Eventos',
      evt1_date:  '2024/03',
      evt1_title: 'First Lego League',
      evt1_place: 'Arrasate / Mondragón',
      evt1_desc:  'Voluntario como jurado de proyectos científicos en la First Lego League Euskadi.',
      evt2_date:  '2025/02',
      evt2_title: 'First Lego League',
      evt2_place: 'Arrasate / Mondragón',
      evt2_desc:  'Voluntario como jurado de proyectos científicos en la First Lego League Euskadi.',
      evt3_date:  '2025/09/27',
      evt3_title: 'NetcoreConf',
      evt3_place: 'Bilbao',
      evt3_desc:  'Charlas sobre .NET, Azure, Kubernetes, Inteligencia Artificial, Data, Power Platform y todo lo relacionado con el mundo Microsoft.',
      evt7_date:  '2025/11/22',
      evt7_title: 'Puertas Abiertas MU',
      evt7_place: 'Arrasate / Mondragón',
      evt7_desc:  'Ponente en las Puertas Abiertas de Mondragon Unibertsitatea. Presentando proyectos PBL a futuros estudiantes y sus familias.',
      evt8_date:  '2026/01/17',
      evt8_title: 'Puertas Abiertas MU',
      evt8_place: 'Arrasate / Mondragón',
      evt8_desc:  'Ponente en las Puertas Abiertas de Mondragon Unibertsitatea. Presentando proyectos PBL a futuros estudiantes y sus familias.',
      evt4_date:  '2026/02',
      evt4_title: 'First Lego League',
      evt4_place: 'Arrasate / Mondragón',
      evt4_desc:  'Voluntario como jurado de proyectos científicos en la First Lego League Euskadi.',
      evt6_date:  '2026/03/07',
      evt6_title: 'Cursor Meetup Bilbao',
      evt6_place: 'Bilbao',
      evt6_desc:  'Charlas, demos y networking sobre desarrollo asistido por IA.',
      evt9_date:  '2026/03/14',
      evt9_title: 'Puertas Abiertas MU',
      evt9_place: 'Arrasate / Mondragón',
      evt9_desc:  'Ponente en las Puertas Abiertas de Mondragon Unibertsitatea. Presentando proyectos PBL a futuros estudiantes y sus familias.',
      evt5_date:  '2026/05/14',
      evt5_title: 'ApplAI',
      evt5_place: 'Donostia',
      evt5_desc:  'El Congreso de la IA Aplicada de Euskadi.',
